...
- [unit-tests for these examples](https://github.com/hevans90/ng-test-material/blob/master/rxjs-examples/function-examples.spec.ts), written using [jasmine-marbles](https://github.com/synapse-wireless-labs/jasmine-marbles): `yarn test-rxjs`
